                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('transactions.index','status='.\App\Models\Transaction::ACTIVE)}}"
                               class="btn btn-success">موفق</a>

                            <a href="{{route('transactions.index','status='.\App\Models\Transaction::PENDING)}}"
                               class="btn btn-warning">در حال تراکنش</a>

                            <a href="{{route('transactions.index','status='.\App\Models\Transaction::INACTIVE)}}"
