<footer class="site-footer footer-v1">
    <div class="col-full">
                                        ...
                                        <ul class="list-payment-icons nav">
                                            <li class="nav-item">
                                                <img class="payment-icon-image"
                                                     src="assets/frontend/images/credit-cards/mastercard.svg"
                                                     alt="mastercard"/>
                                            </li>
                                            <li class="nav-item">
                                                <img class="payment-icon-image"
                                                     src="assets/frontend/images/credit-cards/visa.svg" alt="visa"/>
                                            </li>
                                            <li class="nav-item">
                                                <img class="payment-icon-image"
                                                     src="assets/frontend/images/credit-cards/paypal.svg" alt="paypal"/>
                                            </li>
                                            <li class="nav-item">
                                                <img class="payment-icon-image"
                                                     src="assets/frontend/images/credit-cards/maestro.svg" alt="maestro"/>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="footer-secured-by-icons">
                                            <li class="nav-item">
                                                <img class="secure-icons-image"
                                                     src="assets/frontend/images/secured-by/norton.svg" alt="norton"/>
                                            </li>
                                            <li class="nav-item">
                                                <img class="secure-icons-image"
                                                     src="assets/frontend/images/secured-by/mcafee.svg" alt="mcafee"/>
                                            </li>
                                        </ul>
                                    </div>
        ...
        <div class="site-info">
            <div class="col-full">
                <div class="copyright">کپی رایت &copy; 2017 <a href="home-v1.html">بازار فناوری</a>. کلیه حقوق محفوظ
                    است.
                </div>

                <div class="credit">ساخته شده توسط
                    <i class="fa fa-heart"></i> فلان فلانی نسب.
                </div>
